#ifndef OBJSTRUCKTURE_H_INCLUDED
#define OBJSTRUCKTURE_H_INCLUDED
#include<iostream>
#include<list>
#include"cList.h"
#include<algorithm>
...
//	vector extreme_dimensions[2];
   ...
   //  list<obj_material> material_list;
...
//
	cList vertex_list;
	cList vertex_normal_list;
	cList vertex_texture_list;

	cList face_list;
	cList sphere_list;
	cList plane_list;
  cList light_point_list;
  cList light_quad_list;
  cList light_disc_list;
	cList material_list;
...
#endif // OBJSTRUCKTURE_H_INCLUDED
